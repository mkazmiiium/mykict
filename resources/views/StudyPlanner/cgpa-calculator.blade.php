...
<div class="container mt-5">
    ...
    <div class="text-center mb-4">
        ...
        <p class="text-muted">Plan your academic success with ease! Calculate your GPA, forecast CGPA changes, and explore various scenarios.</p>
    </div>
    ...
    <form id="cgpaForm" class="shadow p-4 rounded bg-light">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="currentCgpa" placeholder="e.g., 3.50" step="0.01" min="0" max="4.00">
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" id="targetCgpa" placeholder="e.g., 3.75" step="0.01" min="0" max="4.00">
            </div>
        </div>
        ...
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('SSP.dashboard') }}">Go to Dashboard</a></li>
        </ul>
    </form>
   ...
   document.getElementById('calculateGpa').addEventListener('click', function () {
        ...
        const calculateRequiredGpa = (targetCgpa) => {
            return semesterCredits > 0
                ? ((targetCgpa * (totalCredits + semesterCredits)) - (currentCgpa * totalCredits)) / semesterCredits
                : 0;
        };
        ...
        document.getElementById('requiredGpa').innerText = requiredGpaForTarget > 0 ? requiredGpaForTarget : "N/A";
